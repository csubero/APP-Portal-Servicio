package md56dbea45781ffb2eced3d70962ff266ce;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Refractored.XamForms.PullToRefresh.Droid.PullToRefreshLayoutRenderer, Refractored.XamForms.PullToRefresh.Droid", PullToRefreshLayoutRenderer.class, __md_methods);
	}
	...
	public PullToRefreshLayoutRenderer (android.content.Context p0)
	{
		...
		if (getClass () == PullToRefreshLayoutRenderer.class)
			mono.android.TypeManager.Activate ("Refractored.XamForms.PullToRefresh.Droid.PullToRefreshLayoutRenderer, Refractored.XamForms.PullToRefresh.Droid", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public PullToRefreshLayoutRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == PullToRefreshLayoutRenderer.class)
			mono.android.TypeManager.Activate ("Refractored.XamForms.PullToRefresh.Droid.PullToRefreshLayoutRenderer, Refractored.XamForms.PullToRefresh.Droid", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
